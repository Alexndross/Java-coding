...
public class Account extends IdentifiableEntity {
    ...
    public void deposit(double amount) throws NegativeAmountException {
        try {
            ...
            //Logging
            System.out.println("Balance deposit: " + holder + ", amount: " + LocalDateTime.now());
     ...
     * @throws InsufficientBalanceException if the amount to withdraw os greater than the balance.
